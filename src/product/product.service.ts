...
/*
Here I had to add await, otherwise there was an error.
Teacher doesn't have await but still has Promise<> as return type
 */
        ...
        return await this.productModel.aggregate([
            ...
            },
            {
                $addFields: {
                    ...
                    reviews: {//example of custom function for MongoDB
                        $function: {
